...
Sequel.migration do
  up do
    create_table(:github_releases_history) do
      uuid :id, primary_key: true, default: Sequel.lit('gen_random_uuid()')
      BigInt :external_github_release_id, null: false
      foreign_key :release_id, :github_releases, null: false, on_delete: :cascade, type: :uuid
  ...
  down do
    drop_table(:github_releases_history)
  end
end
