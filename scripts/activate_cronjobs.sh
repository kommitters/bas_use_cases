...
ENV_VARS=(
    ...
    # DIGITAL OCEAN EMAIL
    "DIGITAL_OCEAN_REFRESH_TOKEN=$DIGITAL_OCEAN_REFRESH_TOKEN"
    "DIGITAL_OCEAN_CLIENT_ID=$DIGITAL_OCEAN_CLIENT_ID"
    "DIGITAL_OCEAN_CLIENT_SECRET=$DIGITAL_OCEAN_CLIENT_SECRET"
    "DIGITAL_OCEAN_USER_EMAIL=$DIGITAL_OCEAN_USER_EMAIL"
    "DIGITAL_OCEAN_RECIPIENT_EMAIL=$DIGITAL_OCEAN_RECIPIENT_EMAIL"
)
