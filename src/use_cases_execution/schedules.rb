...
module UseCasesExecution
  ...
  module Schedules
    ...
    NOTION_WAREHOUSE_SYNC_SCHEDULES = [
      ...
      { path: "#{__dir__}/warehouse/notion/fetch_weekly_scopes.rb", time: ['05:10'] },
      { path: "#{__dir__}/warehouse/notion/fetch_key_results.rb", time: ['05:15'] },
      { path: "#{__dir__}/warehouse/notion/fetch_projects.rb", time: ['05:20'] },
      ...
      { path: "#{__dir__}/warehouse/notion/warehouse_ingester.rb", interval: 3600 }
    ].freeze
  end
end
