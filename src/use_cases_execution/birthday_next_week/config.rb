...
module Config
  ...
  SCHEDULE = [
    { path: "/fetch_next_week_birthday_from_notion.rb", interval: 1000 },
    { path: "/format_next_week_birthday.rb", interval: 1000},
    { path: "/garbage_collector.rb", interval: 1000},
    { path: "/notify_next_week_birthday_in_discord.rb", interval: 1000}
  ].freeze
end
