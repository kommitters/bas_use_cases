...
##
# This file is used to store the configuration of the holidays use case.
# It contains the connection information to the database where the holidays data is stored.
