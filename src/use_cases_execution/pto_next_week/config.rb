...
module Config
  ...
  SCHEDULE = [
    { path: "/fetch_next_week_pto_from_notion.rb", interval: 1000 },
    { path: "/humanize_next_week_pto.rb", interval: 1000},
    { path: "/garbage_collector.rb", interval: 1000},
    { path: "/notify_next_week_pto_in_discord.rb", interval: 1000}
  ].freeze
end
