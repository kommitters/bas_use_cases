...
# Cronjobs
CRON_JOBS=(
    "*/1 12-23 * * MON-FRI fetch_images_from_notion.rb"
    "*/1 12-23 * * MON-FRI write_image_review_requests.rb"
    "*/1 12-23 * * MON-FRI review_image.rb"
    "*/1 12-23 * * MON-FRI write_image_review_in_notion.rb"
