...
# Cronjobs
CRON_JOBS=(
    "47 20 * * * fetch_next_week_birthday_from_notion.rb"
    "48 20 * * * format_next_week_birthday.rb"
    "49 20 * * * notify_next_week_birthday_in_discord.rb"
    "50 20 * * * garbage_collector.rb"
)
