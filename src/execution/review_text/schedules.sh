...
# Cronjobs
CRON_JOBS=(
    "*/1 15-22 * * MON-FRI fetch_text_from_notion.rb"
    "*/1 15-22 * * MON-FRI write_text_review_requests.rb"
    "*/1 15-22 * * MON-FRI review_text.rb"
    "*/1 15-22 * * MON-FRI write_text_review_in_notion.rb"
