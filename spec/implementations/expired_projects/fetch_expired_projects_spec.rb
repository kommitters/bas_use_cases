...
require 'rspec'
require_relative '../../../src/implementations/fetch_expired_projects'
require 'bas/shared_storage/default'
require 'bas/shared_storage/postgres'
require 'bas/shared_storage/types/read'

ENV['NOTION_EXPIRED_PROJECTS_DATABASE_ID'] = 'NOTION_EXPIRED_PROJECTS_DATABASE_ID'
ENV['NOTION_SECRET'] = 'NOTION_SECRET'

RSpec.describe Implementation::FetchExpiredProjects do
  ...
  before do
    ...
    options = {
      database_id: ENV.fetch('NOTION_EXPIRED_PROJECTS_DATABASE_ID'),
    ...
    @bot = Implementation::FetchExpiredProjects.new(options,
  ...
  context '.execute' do
    before do
      bas_bot = instance_double(Implementation::FetchExpiredProjects)

      allow(Implementation::FetchExpiredProjects).to receive(:new).and_return(bas_bot)
