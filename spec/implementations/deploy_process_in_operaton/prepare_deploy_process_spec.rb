...
require 'rspec'
require_relative '../../../src/implementations/prepare_deploy_process'
require 'bas/shared_storage/postgres'

RSpec.describe Implementation::PrepareDeployProcess do
  ...
  before do
    ...
    @bot = Implementation::PrepareDeployProcess.new(options, mocked_shared_storage)
  end

  context '.execute' do
    before do
      allow(@bot).to receive(:process).and_return({
                                                    success: { file_path: 'dummy.bpmn',
