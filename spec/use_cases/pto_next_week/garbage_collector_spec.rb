...
require 'rspec'
require_relative '../../../src/use_cases/pto_next_week/garbage_collector'
...
RSpec.describe GarbageCollector::NextWeekPto do
  before do
    params = {
    ...
    @bot = GarbageCollector::NextWeekPto.new(params)
  end
