...
require 'rspec'
require_relative '../../../src/use_cases/pto_next_week/notify_next_week_pto_in_discord'

ENV['NEXT_WEEK_PTO_DISCORD_WEBHOOK'] = 'NEXT_WEEK_PTO_DISCORD_WEBHOOK'
...
RSpec.describe Notify::NextWeekPtoInDiscord do
  before do
    params = {
