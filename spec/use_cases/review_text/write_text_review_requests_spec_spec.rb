...
require 'rspec'
require_relative '../../../src/use_cases/review_text/write_text_review_requests'
...
RSpec.describe Write::TextReviewRequests do
  before do
    params = {
    ...
    @bot = Write::TextReviewRequests.new(params)
  end
