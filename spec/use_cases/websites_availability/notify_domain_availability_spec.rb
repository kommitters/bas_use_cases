...
require 'rspec'
require_relative '../../../src/use_cases/websites_availability/notify_domain_availability'

ENV['WEBSITES_AVAILABILITY_DISCORD_WEBHOOK'] = 'WEBSITES_AVAILABILITY_DISCORD_WEBHOOK'
...
RSpec.describe Notify::DomainAvailability do
  before do
    params = {
