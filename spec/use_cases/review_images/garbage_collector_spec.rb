...
require 'rspec'
require_relative '../../../src/use_cases/review_images/garbage_collector'
...
RSpec.describe GarbageCollector::ReviewImages do
  before do
    params = {
    ...
    @bot = GarbageCollector::ReviewImages.new(params)
  end
